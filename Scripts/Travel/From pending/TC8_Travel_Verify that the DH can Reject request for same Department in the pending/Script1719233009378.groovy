...
WebUI.click(findTestObject('General/a_Log out'))
/////////////////////////////////////////////////////// PM Approve the the request and verify that it move to DH's director //////////////////////////////////
...
WebUI.setText(findTestObject('Object Repository/Pending Tasks/Reason to reject'), 'DH reject same from pending ' + datetime)
...
WebUI.verifyElementAttributeValue(findTestObject('Travel/Stage Reject'), 'title', 'Current state', 0 // Verify Pending PM stage
    )
