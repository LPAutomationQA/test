...
WebUI.setText(findTestObject('Accounting/Product_Details_page/Product Name_field'), 'Accounting Officer Product ' + datetime)

WebUI.click(findTestObject('General/Save_button'))

WebUI.delay(5)

WebUI.verifyTextPresent('Accounting Officer Product ' + datetime, false)

'Edit product.'
WebUI.click(findTestObject('General/Edit_button'))

WebUI.setText(findTestObject('Accounting/Product_Details_page/Product Name_field'), 'Accounting Officer edit product ' + 
    datetime)
...
WebUI.verifyTextPresent('Accounting Officer edit product ' + datetime, false)
