...
WebUI.setText(findTestObject('Accounting/Payment_Details_page/Memo_filed'), 'Accounting Officer payment ' + datetime)

WebUI.click(findTestObject('General/Save_button'))

WebUI.delay(5)

WebUI.verifyTextPresent('Accounting Officer payment ' + datetime, false)

'Edit payment.'
WebUI.click(findTestObject('General/Edit_button'))

WebUI.setText(findTestObject('Accounting/Payment_Details_page/Memo_filed'), 'Accounting Officer edit payment ' + datetime)

WebUI.click(findTestObject('General/Save_button'))

WebUI.delay(5)

WebUI.verifyTextPresent('Accounting Officer edit payment ' + datetime, false)
...
WebUI.verifyTextNotPresent('Accounting Officer edit payment ' + date, false)
