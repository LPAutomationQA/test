...
CustomKeywords.'loginHelper.Login.login'('mohammadr@leading-point.com', '1234')
...
WebUI.setText(findTestObject('Helpdesk/Ticket_Details/Ticket_title_field'), 'Support Manager Supervisor ticket ' + datetime)
...
WebUI.verifyTextPresent('Support Manager Supervisor ticket ' + datetime, false)

WebUI.click(findTestObject('General/Edit_button'))

WebUI.setText(findTestObject('Helpdesk/Ticket_Details/Ticket_title_field'), 'Support Manager Supervisor edit ticket ' + 
    datetime)

WebUI.click(findTestObject('General/Save_button'))

WebUI.verifyTextPresent('Support Manager Supervisor edit ticket ' +  datetime, false)
