...
WebUI.setText(findTestObject('Recruitment/Job_Detail_page/Title_field'), 'HR Manger delete Job' + now)
...
WebUI.setText(findTestObject('General/Search_field'), 'HR Manger delete Job' + now)
...
WebUI.setText(findTestObject('Recruitment/Application_Details_page/Application Name_field'), 'HR Manger delete app ' + now)
...
WebUI.verifyTextNotPresent('HR Manger delete app ' + now, false)
...
WebUI.verifyTextNotPresent('HR Manger delete Job' + now, false)
