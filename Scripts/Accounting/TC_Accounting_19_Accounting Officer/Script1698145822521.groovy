...
WebUI.setText(findTestObject('Accounting/Invoice_Details_page/Reference_field'), 'Accounting Officer Post invoice' + datetime)
...
WebUI.click(findTestObject('Accounting/Invoice_Details_page/Confirm_button'))

WebUI.delay(5)


WebUI.verifyElementAttributeValue(findTestObject('Accounting/Invoice_Details_page/Posted_stage'), 'title', 'Current state', 
    0)
