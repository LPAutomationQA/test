...
WebUI.click(findTestObject('Accounting/Bill_Details_page/Bill Date_field'), FailureHandling.STOP_ON_FAILURE)

def date = new Date().format('MM/dd/yyyy')

WebUI.setText(findTestObject('Accounting/Bill_Details_page/Payment Reference_field'), 'Chief Accountant post bill ' + date)

WebUI.click(findTestObject('Accounting/Bill_Details_page/Bill Date_field'))
...
WebUI.setText(findTestObject('Accounting/Bill_Details_page/Analytical Account Group_dropdown'), 'Business Applications Department')

WebUI.sendKeys(findTestObject('Accounting/Bill_Details_page/Analytical Account Group_dropdown'), Keys.chord(Keys.TAB))

WebUI.setText(findTestObject('Accounting/Bill_Details_page/Analytic Account_dropdown'), 'BA_SalesPoi')
...
WebUI.sendKeys(findTestObject('Accounting/Bill_Details_page/Analytic Tags_dropdown'), Keys.chord(Keys.TAB))

WebUI.click(findTestObject('General/Save_button'))

WebUI.delay(5)

WebUI.click(findTestObject('Accounting/Bill_Details_page/Confirm_button'))
