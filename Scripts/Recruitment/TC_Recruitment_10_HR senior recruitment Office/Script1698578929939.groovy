...
WebUI.setText(findTestObject('Recruitment/Job_Detail_page/Title_field'), 'HR Senior edit Job' + now)

WebUI.click(findTestObject('General/Save_button'))

WebUI.verifyTextPresent('HR Senior edit Job' + now, false)

WebUI.click(findTestObject('General/Back_level_0'))

WebUI.setText(findTestObject('General/Search_field'), 'HR Senior edit Job' + now)
...
WebUI.setText(findTestObject('Recruitment/Application_Details_page/Application Name_field'), 'HR Senior edit app ' + now)

WebUI.click(findTestObject('General/Save_button'))

WebUI.verifyTextPresent('HR Senior edit app ' + now, false)
