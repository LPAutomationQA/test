...
def date = new Date().plus(6).format('dd/MM/yyyy')
...
String TimeOffDescription = 'SH Reject Time off in req ' + datetime
...
WebUI.setText(findTestObject('Object Repository/Page_Login/input_Email'), findTestData('Employees under SH').getValue(4, 
        randomNumber).trim())
...
WebUI.setText(findTestObject('TimeOff/Reason to reject timeoff'), 'SH reject in req' + datetime)
