...
def date = new Date().plus(5).format('dd/MM/yyyy')
...
WebUI.verifyElementText(findTestObject('TimeOff/Responsible Approver'), findTestData('Employees under SH').getValue(3, randomNumber))
