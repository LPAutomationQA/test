...
WebUI.setText(findTestObject('Accounting/Payment_Details_page/Memo_filed'), 'Accounting Officer post payment ' + datetime)

WebUI.click(findTestObject('General/Save_button'))

WebUI.delay(5)

WebUI.click(findTestObject('Accounting/Payment_Details_page/Confirm_button'))

WebUI.delay(5)


WebUI.verifyElementAttributeValue(findTestObject('Accounting/Payment_Details_page/Posted_stage'), 'title', 'Current state', 
    0)
