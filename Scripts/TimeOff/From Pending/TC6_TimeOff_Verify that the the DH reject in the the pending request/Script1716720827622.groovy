...
String TimeOffDescription = 'DH Time off in pending ' + datetime
...
WebUI.verifyElementText(findTestObject('TimeOff/Responsible Approver'), findTestData('Employees under DH').getValue(2, randomNumber))
