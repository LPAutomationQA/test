...
WebUI.setText(findTestObject('Accounting/Bill_Details_page/Payment Reference_field'), 'Accounting Officer edit bill ' + 
    datetime)
...
WebUI.verifyTextPresent('Accounting Officer edit bill ' + date, false)
...
WebUI.verifyTextNotPresent('Accounting Officer edit bill ' + date, false)
