...
WebUI.setText(findTestObject('Travel/input_Employee'), 'basel ahma')

WebUI.sendKeys(findTestObject('Travel/input_Employee'), Keys.chord(Keys.TAB))
...
WebUI.setText(findTestObject('Travel/input_project director'), 'BA_Awasr_SalesPoint')

WebUI.sendKeys(findTestObject('Travel/input_project director'), Keys.chord(Keys.TAB))

WebUI.setText(findTestObject('Travel/input_Employee'), 'Basel Ahmad  Yacoub Hijazi')
