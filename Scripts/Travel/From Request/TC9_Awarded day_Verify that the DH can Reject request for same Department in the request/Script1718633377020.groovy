...
WebUI.click(findTestObject('Awarded day/span_Reject'))

WebUI.setText(findTestObject('Object Repository/Pending Tasks/Reason to reject'), 'DH reject other from req ' + datetime)
