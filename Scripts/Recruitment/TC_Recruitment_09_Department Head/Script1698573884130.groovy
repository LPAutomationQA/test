...
WebUI.setText(findTestObject('General/Search_field'), 'Department head job ' + now)
...
WebUI.setText(findTestObject('Recruitment/Job_Detail_page/Title_field'), 'Department head edit job ' + now)

WebUI.click(findTestObject('General/Save_button'))

WebUI.verifyTextPresent('Department head edit job ' + now, false)

WebUI.click(findTestObject('General/Back_level_0'))

WebUI.setText(findTestObject('General/Search_field'), 'Department head edit job ' + now)
...
WebUI.setText(findTestObject('Recruitment/Application_Details_page/Application Name_field'), 'Department head edit app' + 
    now)

WebUI.click(findTestObject('General/Save_button'))

WebUI.verifyTextPresent('Department head edit app' + now, false)
