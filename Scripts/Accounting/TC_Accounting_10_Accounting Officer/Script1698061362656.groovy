...
WebUI.setText(findTestObject('Accounting/Invoice_Details_page/Reference_field'), 'Accounting Officer edit invoice ' + datetime)
...
WebUI.verifyTextPresent('Accounting Officer edit invoice ' + date, false)
...
WebUI.verifyTextNotPresent('Accounting Officer edit invoice ' + date, false)
