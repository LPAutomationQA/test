...
CustomKeywords.'loginHelper.Login.login'('abdallahab@leading-point.com', '1234')
...
WebUI.navigateToUrl('https://leading-point-ltd-erp-leading-point-erp-stg-9058525.dev.odoo.com/web#action=864&model=helpdesk.team&view_type=list&cids=2&menu_id=526')

WebUI.verifyTextPresent('Access Error', false)

WebUI.click(findTestObject('General/Ok_Delete_button'))

WebUI.navigateToUrl('https://leading-point-ltd-erp-leading-point-erp-stg-9058525.dev.odoo.com/web#id=2&action=864&model=helpdesk.team&view_type=form&cids=2&menu_id=526')
