...
def date = new Date().plus(3).format('dd/MM/yyyy')
...
WebUI.setText(findTestObject('Page_Login/input_Email'), findTestData('Employees under Director').getValue(1, randomNumber))
...
String TimeOffDescription = 'Employee Time off in pending ' + datetime
...
WebUI.verifyElementText(findTestObject('TimeOff/Responsible Approver'), findTestData('Employees under Director').getValue(2, randomNumber))
...
WebUI.setText(findTestObject('Object Repository/Page_Login/input_Email'), findTestData('Employees under Director').getValue(3, 
        randomNumber))
