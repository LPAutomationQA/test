...
CustomKeywords.'loginHelper.Login.login'('alaaldina@leading-point.com', '123')
...
WebUI.verifyTextPresent('Ahmad Ziad Badawi Al-saheb', false)

WebUI.verifyTextPresent('Feras Ahmad Ismail Arafah', false)

WebUI.verifyTextPresent('Muthaffar Khalil Abdul Aziz Elyyan', false)
