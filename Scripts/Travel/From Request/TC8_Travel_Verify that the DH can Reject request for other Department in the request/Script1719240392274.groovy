...
WebUI.click(findTestObject('Travel/span_Approve By PM'))

WebUI.delay(2)

WebUI.verifyElementText(findTestObject('Travel/Responsible Approver'), 'Ali Ismail Jebreel Shehadeh' // Verify that the responsible approval is DH
    )
...
WebUI.setText(findTestObject('Object Repository/Pending Tasks/Reason to reject'), 'DH reject same from req ' + datetime)
