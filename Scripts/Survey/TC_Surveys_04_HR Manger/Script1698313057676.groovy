...
WebUI.setText(findTestObject('Survey/Survey_details_page/Survey Title_field'), 'HR Manger edit Survey ' + datetime)

WebUI.click(findTestObject('General/Save_button'))

WebUI.verifyTextPresent('HR Manger edit Survey ' + datetime, false)
