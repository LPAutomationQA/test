...
WebUI.setText(findTestObject('Helpdesk/Ticket_Details/Ticket_title_field'), 'Support Engineer delete ticket ' + 
    datetime)
...
WebUI.verifyTextPresent('Support Engineer delete ticket ' + datetime, false)
...
WebUI.verifyTextNotPresent('Support Engineer delete ticket ' + datetime, false)
