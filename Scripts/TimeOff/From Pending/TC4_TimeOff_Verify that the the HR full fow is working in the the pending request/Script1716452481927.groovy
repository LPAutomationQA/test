...
WebUI.setText(findTestObject('Page_Login/input_Email'), findTestData('HR Employee').getValue(1, randomNumber))
...
String TimeOffDescription = 'HR Time off in pending ' + datetime
...
WebUI.setText(findTestObject('Object Repository/Page_Login/input_Email'), findTestData('HR Employee').getValue(3, 
        randomNumber))
