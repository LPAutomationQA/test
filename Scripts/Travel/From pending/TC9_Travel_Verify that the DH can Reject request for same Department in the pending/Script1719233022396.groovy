...
WebUI.setText(findTestObject('Travel/input_project'), 'MO_IntraCast')
...
WebUI.verifyElementText(findTestObject('Travel/Responsible Approver'), 'Manal Dyab Abed Ali' // Verify that the responsible approval is PM
    )
...
WebUI.verifyElementText(findTestObject('Travel/Responsible Approver'), 'Basel m.fatehy m.shafeeq altamimi' // Verify that the responsible approval is DH
    )
...
WebUI.click(findTestObject('Pending Tasks/span_Reject'))

WebUI.setText(findTestObject('Object Repository/Pending Tasks/Reason to reject'), 'DH reject other from pending ' + datetime)

WebUI.click(findTestObject('Object Repository/Pending Tasks/Reject button in pending'))
...
WebUI.verifyElementAttributeValue(findTestObject('Travel/Stage Reject'), 'title', 'Current state', 0 // Verify reject 
	)
