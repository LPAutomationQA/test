...
WebUI.setText(findTestObject('Recruitment/Application_Details_page/Application Name_field'), 'DH delete app ' + now)

WebUI.click(findTestObject('General/Save_button'))

WebUI.click(findTestObject('General/Action_link'))

WebUI.verifyElementNotPresent(findTestObject('General/Delete_link'), 0)
