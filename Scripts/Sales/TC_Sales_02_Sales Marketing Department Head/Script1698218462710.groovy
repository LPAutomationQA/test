...
//
//WebUI.click(findTestObject('Sales/Quotations_Details_page/Add a product_link'))
//
//WebUI.setText(findTestObject('Sales/Quotations_Details_page/Product_dropdown'), 'Business Ana')
//
//WebUI.sendKeys(findTestObject('Sales/Quotations_Details_page/Product_dropdown'), Keys.chord(Keys.TAB))
//
//WebUI.setText(findTestObject('Sales/Quotations_Details_page/Choose Product Variants_filed'), '3')
//
//WebUI.click(findTestObject('Sales/Quotations_Details_page/Confirm Choose Product Variants_button'))
//
