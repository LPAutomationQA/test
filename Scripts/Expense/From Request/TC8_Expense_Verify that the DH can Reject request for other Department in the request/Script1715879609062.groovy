...
String ExpenseName = 'DH reject from req for other ' + datetime
...
WebUI.setText(findTestObject('Expense/Expense_Pages/Reason to reject Expense'), 'DH reject other from req' + datetime)
