...
WebUI.setText(findTestObject('Survey/Survey_details_page/Survey Title_field'), 'HR Survey Senior Officer delete Survey ' + datetime)
...
WebUI.verifyTextPresent('HR Survey Senior Officer delete Survey ' + datetime, false)
...
WebUI.verifyTextNotPresent('HR Survey Senior Officer delete Survey ' + datetime, false)
