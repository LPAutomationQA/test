...
WebUI.setText(findTestObject('Helpdesk/Ticket_Details/Ticket_title_field'), 'Support Manager Supervisor delete ticket ' + datetime)
...
WebUI.verifyTextPresent('Support Manager Supervisor delete ticket ' + datetime, false)
...
WebUI.verifyTextNotPresent('Support Manager Supervisor delete ticket ' + datetime, false)
