...
String ExpenseName = 'DH Expense other Dep req' + datetime
...
WebUI.setText(findTestObject('Expense/Expense_Pages/input_Project'), 'BA_Tkitat')
...
WebUI.verifyElementText(findTestObject('Expense/Expense_Pages/Responsible Approver'), 'Ali Ismail Jebreel Shehadeh')
