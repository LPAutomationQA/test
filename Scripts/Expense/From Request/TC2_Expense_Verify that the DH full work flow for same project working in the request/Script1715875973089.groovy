...
String ExpenseName = 'DH Expense Same Dep req' + datetime
...
WebUI.click(findTestObject('Expense/Expense_Pages/span_Approve By PM'))

WebUI.delay(2)

WebUI.verifyElementText(findTestObject('Expense/Expense_Pages/Responsible Approver'), 'Basel Ahmad Yacoub Hijazi')
...
WebUI.setText(findTestObject('Object Repository/Page_Login/input_Email'), 'baselh@leading-point.com')
...
WebUI.click(findTestObject('Expense/Expense_Pages/Approve_button'))
