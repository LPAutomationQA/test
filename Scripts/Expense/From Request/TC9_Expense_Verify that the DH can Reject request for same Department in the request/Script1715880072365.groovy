...
String ExpenseName = 'DH reject from req for same' + datetime
...
WebUI.setText(findTestObject('Expense/Expense_Pages/Reason to reject Expense'), 'DH reject same from req' + datetime)
