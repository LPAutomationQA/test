...
WebUI.setText(findTestObject('Page_Login/input_Email'), findTestData('HR Employee').getValue(1, randomNumber).trim())
...
String TimeOffDescription = 'HR Time off in req ' + datetime
...
WebUI.verifyElementText(findTestObject('TimeOff/Responsible Approver'), findTestData('HR Employee').getValue(2, randomNumber))
...
WebUI.setText(findTestObject('Object Repository/Page_Login/input_Email'), findTestData('HR Employee').getValue(3, randomNumber).trim())
