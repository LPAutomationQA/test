...
CustomKeywords.'loginHelper.Login.login'('manal.ali@leading-point.com', '1234')
...
WebUI.verifyTextNotPresent('AlaAldin Mohammad Ahmad Alzubi', false)

WebUI.verifyTextNotPresent('Feras Ahmad Ismail Arafah', false)

WebUI.verifyTextNotPresent('Iyad Ismail Hasan Zabalawi', false)

WebUI.verifyTextPresent('Manal Dyab Abed Ali', false)
