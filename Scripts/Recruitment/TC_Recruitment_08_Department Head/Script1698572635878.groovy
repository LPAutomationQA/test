...
WebUI.setText(findTestObject('Recruitment/Job_Detail_page/Title_field'), 'Department head job ' + now)
...
WebUI.verifyTextPresent('Department head job ' + now, false)
...
WebUI.setText(findTestObject('Recruitment/Application_Details_page/Application Name_field'), 'Department head ' + now)

WebUI.click(findTestObject('General/Save_button'))

WebUI.verifyTextPresent('Department head ' + now, false)
