...
WebUI.verifyElementVisible(findTestObject('Accounting/Accounting_Dashboard_Page/Accounting_tab'))

WebUI.click(findTestObject('Accounting/Accounting_Dashboard_Page/Accounting_tab'))

WebUI.click(findTestObject('Accounting/Accounting_Dashboard_Page/Journal Entries_link'))
...
WebUI.verifyTextPresent('Ibrahim Ismail Mostafa Al-Kaimary', false)
